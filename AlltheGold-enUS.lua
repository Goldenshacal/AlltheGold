-- AlltheGold-enUS.lua
-- $Id$
if not AlltheGold_revision then AlltheGold_revision = {} end
AlltheGold_revision.enUS	= ("$Revision$"):match("(%d+)")


--local L = AceLibrary("AceLocale-2.2"):new("AlltheGold")
...
L["Total %s Gold Value: "]                               			= true
L["Total Time Played: "]                                 			= true
L["Total Gold Value: "]                                  			= true
L["Total PvP: "]																	= true
L["Total XP: "]																	= true
L["Unknown"]																		= true
L["%.1f M XP"]																		= true
